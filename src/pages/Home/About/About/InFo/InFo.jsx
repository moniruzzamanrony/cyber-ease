...
<div className="flex justify-center items-center  px-4">
  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-20 text-left w-full max-w-4xl">
    ...
    <div className="max-w-md mx-auto">
      <h3 className="text-4xl font-bold mb-6 text-[rgba(0,0,0,0.82)]">Mission.</h3>
      <p className=" mt-2 text-[rgba(0,0,0,0.82)]">
    ...
    {/* Vision */}
    <div className="max-w-md mx-auto">
      <h3 className="text-4xl font-bold mb-6 text-[rgba(0,0,0,0.82)]">Vision.</h3>
      <p className=" mt-2 text-[rgba(0,0,0,0.82)]">
